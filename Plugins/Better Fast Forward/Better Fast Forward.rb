...
#                          v1.0 - Essentials v19.1                             #
#                             Modded by Zeak6464                               #
#                                 by Marin                                     #
#==============================================================================#
#                                   Usage                                      #
#                                                                              #
# SPEEDUP_STAGES are the speed stages the game will pick from. If you click F7,#
...
# When the user clicks F7, it'll pick the next number in this array.
...
module Graphics
  ...
  def self.update
    if $CanToggle && Input.trigger?(Input::F7)
      $GameSpeed += 1
